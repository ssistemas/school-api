...
abstract class Repository implements RepositoryContract
{
    ...
    /**
     * Switch between tenant only and global scopes.
     *
     * @param bool $tenantOnly
     *
     * @return $this
     */
    public function tenantOnly(bool $tenantOnly = true)
    {
    ...
    public function newQuery()
    {
        ...
        if ($this->tenantOnly) {
            $query->where('tenant_id', Tenant::currentTenant()->id);
        }
