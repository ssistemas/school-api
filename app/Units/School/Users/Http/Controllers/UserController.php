...
use Emtudo\Units\School\Users\Http\Requests\Users\CreateUserRequest;
use Emtudo\Units\School\Users\Http\Requests\Users\UpdateUserRequest;
...
class UserController extends Controller
{
    ...
    {
        $user = $repository->create($this->params);
    ...
    public function destroy($id, UserRepository $repository)
    {
        ...
        if (!$deleted) {
            return $this->respond->error('Falha ao excluir usuário');
        }
